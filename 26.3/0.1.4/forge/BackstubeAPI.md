...
| [`createDisc(DeferredRegister<Item>, Identifier, Item.Properties, BackstubeMusicDisc)`](#createdisc-deferredregister-item-identifier-item-properties-backstubemusicdisc) | Registers a code-based disc together with a custom `Item` bound to its registry entry. |
| [`createDisc(DeferredRegister<Item>, Identifier, Item.Properties, Function<Item.Properties, T>, BackstubeMusicDisc)`](#createdisc-deferredregister-item-identifier-item-properties-function-item-properties-t-backstubemusicdisc) | Registers a code-based disc together with a custom `Item` subclass. |
...
> **See also:** [`createDisc(DeferredRegister, Identifier, Item.Properties, BackstubeMusicDisc)`](#createdisc-deferredregister-identifier-item-properties-backstubemusicdisc)
> 
> **Since** 0.1.0
...
### `createDisc(DeferredRegister<Item>, Identifier, Item.Properties, BackstubeMusicDisc)`

```java
public static RegistryObject<Item> createDisc(DeferredRegister<Item> register, Identifier id, Item.Properties properties, BackstubeMusicDisc disc)
```
...
**Returns:** a `RegistryObject<Item>` pointing at the deferred item;
never `null`

> **See also:** [`createDisc(DeferredRegister, Identifier, Item.Properties, Function, BackstubeMusicDisc)`](#createdisc-deferredregister-identifier-item-properties-function-backstubemusicdisc)
> 
> **Since** 0.1.0

---

### `createDisc(DeferredRegister<Item>, Identifier, Item.Properties, Function<Item.Properties, T>, BackstubeMusicDisc)`
...
Identical to
[`createDisc(DeferredRegister, Identifier, Item.Properties, BackstubeMusicDisc)`](#createdisc-deferredregister-identifier-item-properties-backstubemusicdisc) but
