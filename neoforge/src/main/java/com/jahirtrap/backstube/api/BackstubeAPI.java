...
public class BackstubeAPI {
     ...
     * @see #createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, BackstubeMusicDisc)
     * @since 0.1.2
     */
     ...
     * never {@code null}
     * @see #createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, Function, BackstubeMusicDisc)
     * @since 0.1.3
     */
     ...
     * <p>
     * Identical to
     * {@link #createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, BackstubeMusicDisc)} but
