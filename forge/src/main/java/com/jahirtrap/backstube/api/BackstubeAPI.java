...
public class BackstubeAPI {
     ...
     * @see #createDisc(DeferredRegister, Identifier, Item.Properties, BackstubeMusicDisc)
     * @since 0.1.0
     */
    public static Item.Properties discProperties(ResourceKey<BackstubeMusicDisc> diskKey) {
        return new Item.Properties()
                .stacksTo(1)
                .delayedComponent(ModComponents.DISC.get(), context -> context.getOrThrow(diskKey))
     ...
     * @return a {@code RegistryObject<Item>} pointing at the deferred item;
     * never {@code null}
     * @see #createDisc(DeferredRegister, Identifier, Item.Properties, Function, BackstubeMusicDisc)
     * @since 0.1.0
     */
     ...
     * <p>
     * Identical to
     * {@link #createDisc(DeferredRegister, Identifier, Item.Properties, BackstubeMusicDisc)} but
    ...
    public static void applyDiscData(ItemStack stack, Holder<BackstubeMusicDisc> disc, HolderLookup.Provider provider) {
        BackstubeMusicDisc value = disc.value();
        stack.set(ModComponents.DISC.get(), disc);
    ...
    public static boolean isDisc(ItemStack stack) {
        return stack.has(ModComponents.DISC.get());
    }
    ...
    public static Optional<Holder<BackstubeMusicDisc>> readDisc(ItemStack stack) {
        return Optional.ofNullable(stack.get(ModComponents.DISC.get()));
    }
