...
| [`createDisc(ResourceLocation, Item.Properties, BackstubeMusicDisc)`](#createdisc-resourcelocation-item-properties-backstubemusicdisc) | Registers a code-based disc together with a `RecordItem` bound to its registry entry. |
| [`createDisc(ResourceLocation, Item.Properties, Function<Item.Properties, T>, BackstubeMusicDisc)`](#createdisc-resourcelocation-item-properties-function-item-properties-t-backstubemusicdisc) | Registers a code-based disc together with a custom `RecordItem` subclass. |
...
> **See also:** [`createDisc(ResourceLocation, Item.Properties, BackstubeMusicDisc)`](#createdisc-resourcelocation-item-properties-backstubemusicdisc)
> 
> **Since** 0.1.2
...
### `createDisc(ResourceLocation, Item.Properties, BackstubeMusicDisc)`
...
**Returns:** the newly registered `RecordItem`; never `null`

> **See also:** [`createDisc(ResourceLocation, Item.Properties, Function, BackstubeMusicDisc)`](#createdisc-resourcelocation-item-properties-function-backstubemusicdisc)
> 
> **Since** 0.1.3

---

### `createDisc(ResourceLocation, Item.Properties, Function<Item.Properties, T>, BackstubeMusicDisc)`
...
Identical to
[`createDisc(ResourceLocation, Item.Properties, BackstubeMusicDisc)`](#createdisc-resourcelocation-item-properties-backstubemusicdisc) but
