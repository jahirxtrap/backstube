...
| [`createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, BackstubeMusicDisc)`](#createdisc-deferredregister-items-resourcelocation-item-properties-backstubemusicdisc) | Registers a code-based disc together with a custom `Item` bound to its registry entry. |
| [`createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, Function<Item.Properties, T>, BackstubeMusicDisc)`](#createdisc-deferredregister-items-resourcelocation-item-properties-function-item-properties-t-backstubemusicdisc) | Registers a code-based disc together with a custom `Item` subclass. |
...
> **See also:** [`createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, BackstubeMusicDisc)`](#createdisc-deferredregister-items-resourcelocation-item-properties-backstubemusicdisc)
> 
> **Since** 0.1.2
...
### `createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, BackstubeMusicDisc)`

```java
public static DeferredItem<Item> createDisc(DeferredRegister.Items register, ResourceLocation id, Item.Properties properties, BackstubeMusicDisc disc)
```
...
**Returns:** a `DeferredItem<Item>` handle for the registered item;
never `null`

> **See also:** [`createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, Function, BackstubeMusicDisc)`](#createdisc-deferredregister-items-resourcelocation-item-properties-function-backstubemusicdisc)
> 
> **Since** 0.1.3

---

### `createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, Function<Item.Properties, T>, BackstubeMusicDisc)`

```java
public static <T extends Item> DeferredItem<T> createDisc(DeferredRegister.Items register, ResourceLocation id, Item.Properties properties, Function<Item.Properties, T> factory, BackstubeMusicDisc disc)
```

Registers a code-based disc together with a custom `Item` subclass.

Identical to
[`createDisc(DeferredRegister.Items, ResourceLocation, Item.Properties, BackstubeMusicDisc)`](#createdisc-deferredregister-items-resourcelocation-item-properties-backstubemusicdisc) but
...
**Returns:** a `DeferredItem<T>` handle for the registered item,
