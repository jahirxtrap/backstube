...
| [`createDisc(ResourceLocation, Item.Properties, BackstubeMusicDisc)`](#createdisc-resourcelocation-item-properties-backstubemusicdisc) | Registers a code-based disc together with a custom `Item` bound to its registry entry. |
| [`createDisc(ResourceLocation, Item.Properties, Function<Item.Properties, T>, BackstubeMusicDisc)`](#createdisc-resourcelocation-item-properties-function-item-properties-t-backstubemusicdisc) | Registers a code-based disc together with a custom `Item` subclass. |
