...
public class BackstubeAPI {
     ...
     * @return the newly registered {@link RecordItem}; never {@code null}
     * @see #createDisc(ResourceLocation, Item.Properties, Function, BackstubeMusicDisc)
     * @since 0.1.3
     */
     ...
     * <p>
     * Identical to
     * {@link #createDisc(ResourceLocation, Item.Properties, BackstubeMusicDisc)} but
